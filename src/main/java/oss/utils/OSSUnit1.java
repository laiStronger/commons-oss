...
public class OSSUnit1 {
    ...
    private static String ACCESS_KEY_ID = "LTAITgVHmUU5cDg5";
    // 阿里云API的密钥Access Key Secret
    private static String ACCESS_KEY_SECRET = "xNxiRNwfpCqZhd8XZBs6Ibfihu5YRV";
    ...
    public static String getClassPath() {
        URL url = OSSUnit1.class.getClassLoader().getResource("");
        return url.getPath();
    }
    ...
    public static void build(String fileName) {
        ...
        if (AssertUtils.isNull(ENDPOINT) || AssertUtils.isNull(ACCESS_KEY_ID)
                || AssertUtils.isNull(ACCESS_KEY_SECRET)) {
    ...
    public static void main(String[] args) {
        OSSClient oss = new OSSClient(ENDPOINT,ACCESS_KEY_ID,ACCESS_KEY_SECRET);
        File file = new File("F:\123.png");
        String bucketName = "test";
        String diskName = "test2";
